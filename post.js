...
Image.prototype.display = function(imageData, callback) {
    ...
    imageData ? this.decoder.convert_yuv2rgb(chroma, y, u, v, w, h, stridey, strideu, stridev, bppy, bppu, bppv, imageData, callback)
        : (callback && callback(chroma, y, u, v, w, h, stridey, strideu, stridev, bppy, bppu, bppv));
};
